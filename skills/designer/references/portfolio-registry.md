...
> `brand.md` when HeardRight is redesigned (Adrian's call — this changes a locked brand).
...
is the hero, live. (Adrian's original idea — now the template-killer for this site.)
...
demonstrated, not claimed. Crisp light, Swiss grid. (Adrian's original idea.)
...
stakes, and the exact thing Adrian called out. Files: `_mockups/b-blueprint-v2.html`, `c-editorial-v2.html`.
...
3. After Adrian approves, write the chosen row back here so the next site differentiates against it.
