...
Easing carries meaning. Different curves communicate different things. **Locked values** — these match `cutright://skill/qa {"mode":"visual_review","reference":"motion-standards"}`. Drift breaks producer/reviewer contract.
