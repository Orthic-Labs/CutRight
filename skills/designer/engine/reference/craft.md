...
Run cutright://skill/designer shape, passing along whatever feature description the user provided. Shape is **required** for craft; it is what produces a confirmed direction.
...
- Responsive requirements? Consult [morph.md](morph.md) (Reference Material covers breakpoints, input methods, safe areas, responsive images)
