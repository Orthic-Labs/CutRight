...
> 实战参考：demos/hero-animation-v9.mp4（上游 pinned revision 中缺失，未随 corpus 导入；见 imports/v2/receipts/designer.json）· [https://www.huasheng.ai/huashu-design-hero/](https://www.huasheng.ai/huashu-design-hero/)
