...
// Execution happens only as the typed capability cutright://capability/designer.sweep
 ...
 *
 * Static-HTML link collection: fine for SSR/static sites (all of Adrian's).
