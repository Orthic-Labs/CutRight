# CR-V2-B1-010 PROVENANCE HEADER — CutRight v2 adaptation.
# Upstream: workspace-capabilities @ 6ee21f03a787e7b57dc412760a8996ea7a235302,
# tools/skills/content/specialists/image-enhancement/scripts/enhance.py
# (see skills/content/THIRD_PARTY.yml).
# This script is INERT PROVENANCE in the base CutRight runtime: the base skill
# requires no Python interpreter and no Pillow installation on PATH.
# Execution happens only as the typed capability cutright://capability/content.enhance
# inside the signed content runtime pack, emitting AssetDelivery records (no direct mutation).
"""
