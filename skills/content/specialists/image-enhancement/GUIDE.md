...
A real Pillow-based script lives at `skills/content/specialists/image-enhancement/scripts/enhance.py` (inert provenance in the base CutRight runtime; the Python interpreter and Pillow ship inside the signed content runtime pack).
...
cutright://capability/content.enhance {"input": "screenshot.png"}

# Scale to a specific width, skip sharpen
cutright://capability/content.enhance {"input": "screenshot.png", "width": 1920, "no_sharpen": true}

# Custom output path
cutright://capability/content.enhance {"input": "screenshot.png", "output": "out/enhanced.png"}
```

Executed inside the signed content runtime pack as the typed capability `content.enhance`
(underlying upstream script: `scripts/enhance.py`); results answer as AssetDelivery records.
