...
- Upstream `ads` lane — campaign strategy, targeting, budgets, and optimization (not vendored into CutRight v2)
- `specialists/copywriting/GUIDE.md` — landing/sales-page conversion copy (where ad traffic lands; this skill's main surface)
- Upstream `marketing` growth lane — structuring creative A/B tests with statistical rigor (not vendored)
- `cutright://skill/writing` — long-form/script/repurposing content that is NOT ad or conversion copy
