...
## Status (CutRight v2)
- Platform connectors (Pinterest Business API) and scheduling execution are excluded.
- Creation-only: pin creative, board strategy, and publishing plans as data for the operator.
...
4. **Generate via `cutright://skill/designer`** with Pinterest preset (upstream marketing-design lane retyped)
5. **Metadata:**
...
- Scheduling execution (Tailwind or native schedulers) is excluded in CutRight v2; cadence is emitted as publishing-plan data
