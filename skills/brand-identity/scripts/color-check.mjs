#!/usr/bin/env node
// CR-V2-B1-009 PROVENANCE HEADER — CutRight v2 adaptation.
// Upstream: workspace-capabilities @ 6ee21f03a787e7b57dc412760a8996ea7a235302,
// tools/skills/brand-identity/scripts (see skills/brand-identity/THIRD_PARTY.yml).
// Zero-dependency pure color math (no network, no child processes, no filesystem writes).
// In the base CutRight runtime it is invoked only as the typed capability
// cutright://capability/brand_identity.color_check inside the signed runtime pack.
